...
namespace FantasyLeague.Api.Migrations
{
    ...
    [Migration("20250922171312_FixBettingForeignKeys")]
    partial class FixBettingForeignKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.AdminTokenAction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AdminTokenActions");
                });

            modelBuilder.Entity("FantasyLeague.Api.Models.Bet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("MatchupBetId")
                        .HasColumnType("integer");

                    b.Property<int?>("MatchupSelection")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("GameBetId");

                    b.HasIndex("LeagueId");

                    b.HasIndex("MatchupBetId");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.BettingLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("FavoriteOdds")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<decimal?>("MaxBetAmount")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal?>("UnderdogOdds")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.ToTable("BettingLines");
                });

            modelBuilder.Entity("FantasyLeague.Api.Models.BettingNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IsRead", "ExpiresAt");

                    b.HasIndex("UserId", "CreatedAt");

                    b.HasIndex("UserId", "IsRead");

                    b.ToTable("BettingNotifications");
                });

            modelBuilder.Entity("FantasyLeague.Api.Models.CashoutRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.EmailDeliveryLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.GameBet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("AwayMoneylineOdds")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<decimal?>("HomeMoneylineOdds")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.HasIndex("LeagueId", "Sport", "GameDateTime");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.MatchupBet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("Team1MoneylineOdds")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("Team1Score")
                        .HasPrecision(6, 1)
                        .HasColumnType("decimal(6,1)");

                    b.Property<int>("Team1UserId")
                        .HasColumnType("integer");

                    b.Property<decimal?>("Team2MoneylineOdds")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");

                    b.Property<decimal?>("Team2Score")
                        .HasPrecision(6, 1)
                        .HasColumnType("decimal(6,1)");

                    b.Property<int>("Team2UserId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("Team2UserId");

                    b.HasIndex("WinnerUserId");

                    b.HasIndex("Team1UserId", "Team2UserId");

                    b.HasIndex("LeagueId", "Week", "Season", "Sport");

                    b.ToTable("MatchupBets");
                });
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.SystemTokenPool", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("HouseBalance")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0.00m);
                    ...
                    b.Property<decimal>("TotalCashedOut")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0.00m);
                    ...
                    b.Property<decimal>("TotalTokensInCirculation")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0.00m);

                    b.Property<decimal>("TotalTokensIssued")
                        .ValueGeneratedOnAdd()
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0.00m);
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.TokenTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.User", b =>
                {
                    ...
                    b.Property<bool>("TradeProposalEmailsEnabled")
                        .HasColumnType("boolean");

                    b.Property<bool>("TradeResponseEmailsEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.UserWallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.AdminTokenAction", b =>
                {
                    b.HasOne("FantasyLeague.Api.Models.User", "AdminUser")
                        .WithMany()
                    ...
                    b.HasOne("FantasyLeague.Api.Models.TokenTransaction", "TokenTransaction")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.Bet", b =>
                {
                    b.HasOne("FantasyLeague.Api.Models.GameBet", "GameBet")
                        .WithMany()
                        .HasForeignKey("GameBetId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("FantasyLeague.Api.Models.MatchupBet", "MatchupBet")
                        .WithMany()
                        .HasForeignKey("MatchupBetId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("FantasyLeague.Api.Models.User", "SettledByAdmin")
                        .WithMany()
                    ...
                    b.Navigation("GameBet");

                    b.Navigation("League");

                    b.Navigation("MatchupBet");

                    b.Navigation("SettledByAdmin");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.BettingLine", b =>
                {
                    b.HasOne("FantasyLeague.Api.Models.User", "CreatedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.BettingNotification", b =>
                {
                    b.HasOne("FantasyLeague.Api.Models.Bet", "Bet")
                        .WithMany()
                        .HasForeignKey("BetId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.CashoutRequest", b =>
                {
                    b.HasOne("FantasyLeague.Api.Models.User", "ProcessedByAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.MatchupBet", b =>
                {
                    ...
                    b.HasOne("FantasyLeague.Api.Models.User", "Team1User")
                        .WithMany()
                        .HasForeignKey("Team1UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FantasyLeague.Api.Models.User", "Team2User")
                        .WithMany()
                        .HasForeignKey("Team2UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FantasyLeague.Api.Models.User", "WinnerUser")
                        .WithMany()
                    ...
                    b.Navigation("Team1User");

                    b.Navigation("Team2User");
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.TokenTransaction", b =>
                {
                    ...
                    b.HasOne("FantasyLeague.Api.Models.UserWallet", null)
            ...
            modelBuilder.Entity("FantasyLeague.Api.Models.UserWallet", b =>
                {
                    b.HasOne("FantasyLeague.Api.Models.User", "User")
                        .WithOne()
                        .HasForeignKey("FantasyLeague.Api.Models.UserWallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
